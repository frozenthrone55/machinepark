  ...
  function initDevicePhotoPicker(deviceId = '') {
    ...
    if (input) input.addEventListener('change', () => {
      ...
      task.then(
        ...
        (error) => {
          console.error(error);
          alert('Een van de media-items kon niet worden verwerkt. Probeer de foto opnieuw toe te voegen.');
        },
      ).finally(() => {
...
(() => {
  ...
  function printComposedDocument(doc){
...
(() => {
  ...
  console.error('[Machinepark feature all-table-columns-sortable-v1]', error);
}
