...
.timeline-service-photo{{width:88px;height:68px;display:block;object-fit:cover;border:1px solid var(--line);border-radius:9px;background:#eef2f0;cursor:zoom-in}}
...
@media(max-width:700px){{
  ...
  .timeline-service-photo{{width:82px;height:64px}}
}}
@media print{{
  .timeline-service-photos{{display:flex;flex-wrap:wrap;gap:2mm;margin-top:2.5mm}}
  .timeline-service-photo{{width:24mm!important;height:19mm!important;object-fit:cover;border:1px solid #ccc;border-radius:2mm;break-inside:avoid}}
}}
</style>
'''
...
print('[Machinepark] onderhouds- en depannagefoto’s staan in Machinedetails tijdlijn')
